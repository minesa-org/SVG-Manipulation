        ...
        if (sprites.length === 0) {
            ...
            sprites.forEach((sprite) => {
                ...
                if (sprite.name) {
                    ...
                    // Highlight belt-related sprites
                    if (sprite.name.toLowerCase().includes("belt")) {
                        item.classList.add("belt-sprite");
                        // Add a special note for belt sprites
                        const noteSpan = document.createElement("span");
                        noteSpan.className = "sprite-note";
                        noteSpan.textContent = " (Belt)";
                        noteSpan.style.color = "#8B4513";
